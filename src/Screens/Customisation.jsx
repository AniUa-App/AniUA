  ...
  const CUSTOMISATION_SETTINGS = [
    {
      ...
      body: [
        ...
        {
          type: "slider",
          title: "Блюр інтенсивність",
          description: `Інтенсивність заблурення панелі`,
          value: USER_CONFIG?.navbar?.blurIntensity,
          intensity: 100,
          onPress: () => {
            setItem(bodyItem);
            setSliderValue(USER_CONFIG?.navbar?.blurIntensity ?? 80);
            openSliderSheet();
          },
          handleSliderChange: (value) => {
            ...
            SET_USER_CONFIG({
              ...USER_CONFIG,
              navbar: { ...USER_CONFIG?.navbar, blurIntensity: value },
            });
          },
          onView: ({ title, value, handleSliderChange }) => {
            return (
        ...
        // {
        //   type: "slider",
        //   title: "Блюр коефіцієнт зменшення розмиття",
        //   value: USER_CONFIG?.navbar?.blurReductionFactor,
        // },
        //   ],
        // },
        // {
        //   title: "Кольори додатка",
        //   body: [
        //     {
        //       type: "colorPicker",
        //       title: "Колір основного кольору",
        //       value: USER_CONFIG?.appColor || appColor,
        //       description: `Колір основного кольору додатка`,
        //     },
        //     {
        //       type: "colorPicker",
        //       title: "Колір для фону",
        //       value: USER_CONFIG?.black || black,
        //       description: `Колір для фонового кольору додатка`,
        //     },
        //     {
        //       type: "colorPicker",
        //       title: "Колір основного тексту",
        //       value: USER_CONFIG?.white || white,
        //       description: `Колір основного тексту додатка`,
        //     },
        //   ],
        // },
        // {
        ...
        //       type: "photoPicker",
        //       title: "Фонове зображення",
        //       value: USER_CONFIG?.backgroundImage || null,
        //       description: `Фонове зображення додатка`,
        //     },
        //     {
        //       type: "button",
        //       title: "Блюр",
        //       description: `${USER_CONFIG?.backgroundBlur ? "Вимкнено" : "Вмикає"} блюр фонового зображення`,
        //       value: USER_CONFIG?.backgroundBlur,
        //     },
        //     {
        //       type: "slider",
        //       title: "Блюр інтенсивність",
        //       description: `Блюр інтенсивність фонового зображення`,
        //       value: USER_CONFIG?.backgroundBlurIntensity,
        //     },
        //     {
        //       type: "slider",
        //       title: "Блюр коефіцієнт зменшення розмиття",
        //       value: USER_CONFIG?.backgroundBlurReductionFactor,
        //     },
      ],
    },
  ];
