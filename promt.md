- Вирішити проблему з тим що історія не оновлюється автоматично - No

- Зробити динамічну висоту для вкладок у профілі, тому що якщо в "улюбленних" аніме більше ніж у вкладці з MonitorPlay, то висота вкладки "Улюблені" завелика для MonitorPlay - No

- Перемістити плашку "Деталі аніме у списках" у CustomizationScreen - Yes

- Після успішного вхіду у профіль Hikka, треба перевірити його у апі AniUA, якщо це новий користувач то переш за все зареєструвати його у AniUa та додати useAniuaUser з усіма необхідними методами - Yes
