...
import AllowTheVideoFolder, { getDocumentDirectory, getVideoDir } from './src/FIleSystem/FileSystem';
  ...
  const setupNavigationBar = async () => {
    return AndroidHelper.safeExecute(async () => {
      ...
      if (navBarType === 'hidden') {
        ...
        await SystemNavigationBar.setBarMode('dark', 'navigation');
    ...
    const initApp = async () => {
      try {
        ...
        Promise.all([
          ...
          AppLogger.logAppInit('Деякі налаштування не вдалося застосувати', false, error);
        });
